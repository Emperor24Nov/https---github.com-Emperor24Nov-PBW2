                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-white">
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr class="bg-gray-900 dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600">
                                        <td class="w-4 p-4">
                                            {{ $loop->iteration }}
                                        </td>
                                        ...
                                        <td colspan="2" class="flex items-center justify-center gap-4 px-6 py-4">
                                            <button class="text-orange-100 font-medium text-yellow-300 dark:text-yellow-500 hover:underline">Edit</button>
